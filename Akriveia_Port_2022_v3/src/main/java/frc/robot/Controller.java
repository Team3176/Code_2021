...
public class Controller {
    ...
    public Controller() {
        ...
        op_ButtonY = new XboxLoneButton(op, Button.kY.value, Button.kLeftBumper.value);
        op_ButtonYPlusBumperLeft = new JoystickButton(op, Button.kY.value).and(new JoystickButton(op, Button.kLeftBumper.value));
        /* Intake */

        op_ButtonA = new XboxLoneButton(op, Button.kA.value, Button.kLeftBumper.value);
        op_ButtonAPlusBumperLeft = new JoystickButton(op, Button.kA.value).and(new JoystickButton(op, Button.kLeftBumper.value));
        // intakeReverseButton = new JoystickButton(op, Button.kBumperLeft.value).and(new JoystickButton(op, Button.kA.value));

        /* Drum */

        op_ButtonBPlusBumperLeft = new JoystickButton(op, Button.kB.value).and(new JoystickButton(op, Button.kLeftBumper.value));
        op_ButtonB = new XboxLoneButton(op, Button.kB.value, Button.kLeftBumper.value);
        op_ButtonBack = new XboxLoneButton(op, Button.kBack.value, Button.kLeftBumper.value);
        op_ButtonBackPlusBumperLeft = new JoystickButton(op, Button.kBack.value).and(new JoystickButton(op, Button.kLeftBumper.value));
        op_ButtonStart = new XboxLoneButton(op, Button.kStart.value, Button.kLeftBumper.value);
        op_ButtonStartPlusBumperLeft = new JoystickButton(op, Button.kStart.value).and(new JoystickButton(op, Button.kLeftBumper.value));
        ...
        op_BumperRight = new JoystickButton(op, Button.kRightBumper.value);
        ...
        angledShooterOffButton = new XboxLoneButton(op, Button.kStart.value, Button.kLeftBumper.value);
        ...
        k2 = new XboxLoneButton(op, Button.kLeftStick.value, Button.kLeftBumper.value);
    }
