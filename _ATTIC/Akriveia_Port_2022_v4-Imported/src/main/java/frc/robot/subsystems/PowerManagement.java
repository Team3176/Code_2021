...
public class PowerManagement extends SubsystemBase {
    ...
    public PowerManagement() {
        PDP = new PowerDistribution(PowerManagementConstants.PDP_CAN_ID, PowerDistribution.ModuleType.kCTRE);
    ...
    /**
     * Returns the PDP (aka PowerDistribution) object, not the entire PowerManagement class
     * @return PowerDistribution PDP
     */
