...
public class Hood extends SubsystemBase {
  ...
  public int pidPosCtrl_buildHoodPositions(int numberOfPositionsDesired) {
    ...
    if (range == 0) {
      // System.out.println("*************ERROR: Hood.buildHoodPositions FAILED due to a 0 range between min and max positions of the Hood***************");
      return 0;
    }
  ...
  public void pidPosCtrl_goUpToNextHoodPosition_Tic(){
    if (hoodPositions_Tics.get(hoodPositions_persistingIndex+1) < hoodController.getSelectedSensorPosition() ) {
      ...
      // System.out.println("*************ERROR:  Hood.goUpToNextHoodPosition :: Already at top of possible Hood positions *****************************");
    }
  }
  ...
  public void pidPosCtrl_goDownToNextHoodPosition_Tic(){
    if (hoodPositions_persistingIndex - 1 >= 0) {
      ...
      // System.out.println("*************ERROR:  Hood.goDownToNextHoodPosition :: Already at bottom of possible Hood positions *****************************");
    }
  }
   ...
   * @see commands.teleop.HoodUp
   * @see commands.teleop.HoodDown
   */
  ...
  public int checkForCurrentSpike() {
    int returnFlag = 0;
    double amps = m_PowerManagement.getHoodAvgAmp();
    if (amps >= 20) {
      ampSpikeCount++;
  ...
  public void periodic() {
    //SmartDashboard.putNumber("Hood Amps", m_PowerManagement.getHoodAvgAmp());
