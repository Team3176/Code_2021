...
public class ShootingLookupTables{
    ...
    // First index of array elements corresponds to horizontal distance to Target (ie, deltaX as reported by VisionClient)
    // Second index of array elements corresponds to vertical distance to Target (ie, deltaY as reported by VisionClient)
